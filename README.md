...
Adds the Fedex shipping method to your shop.
...
Notice a bug or something isn't working as expected? You can create an issue for it here: [github.com/grandeljay/modified-fedex/issues](https://github.com/grandeljay/modified-fedex/issues/new/choose).
